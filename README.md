...
Modular **ROS2 (Robot Operating System 2)** package integrating real-time **YOLOv8 vision perception**, a pure Python multi-state obstacle avoidance controller (`FORWARD`, `SLOW_DOWN`, `TURN_LEFT`, `TURN_RIGHT`, `EMERGENCY_STOP`, `RECOVERY`), Gazebo simulation, RViz visualizers, and edge telemetry streaming to PostgreSQL / Zenoh.
...
| :--- | :---: | :--- |
| **Collision-Free Completion Rate** | **100.0%** | Trial runs completed without obstacle collision |
